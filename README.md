...
- 왼쪽 앞 창가에는 적국 위(魏)의 **사마의**가 홀로 서 있습니다. 조회 마지막에 **"맞수의 한마디"**로 승상과 반대되는 조언을 던집니다 — 정사 속 사마의처럼 "멈추고 쉬어라, 때를 기다려라, 남에게 맡겨라, 이길 싸움만 하라" 쪽으로.
...
- 아래 **대화창**에 말하는 사람의 초상화·이름과 대사가 차례로 나옵니다. 말하는 캐릭터는 머리 위에 '…' 말풍선이 뜨고 통통 튑니다.
  ...
  - 대화창을 **눌러야**(또는 Enter) 다음 대사로 넘어갑니다. 저절로 넘어가지 않으니 천천히 읽으세요. 마지막 대사에서 누르면 처음부터 다시 봅니다.
